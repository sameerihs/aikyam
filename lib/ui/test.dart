...
class PureNFC extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => PureNFCState();
}

class PureNFCState extends State<PureNFC> {
  ...
  void _tagRead() {
    NfcManager.instance.startSession(onDiscovered: (NfcTag tag) async {
      result.value = decodeNfcPayload(tag);
      print(result.value);
  ...
  void _ndefWrite() {
    NfcManager.instance.startSession(onDiscovered: (NfcTag tag) async {
      ...
      NdefMessage message = NdefMessage([
        NdefRecord.createText('Hello Sameer!'),
        NdefRecord.createText('123'),
        NdefRecord.createText('45699'),
